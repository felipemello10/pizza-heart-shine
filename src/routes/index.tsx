    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="absolute top-0 left-0 right-0 z-30">
        <div className="mx-auto max-w-7xl px-6 py-6 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-cream/90">
            ...
            <a href="#vozes" className="hover:text-accent transition">Avaliações</a>
      ...
      <footer className="bg-ink text-cream/70 py-12">
        <div className="mx-auto max-w-7xl px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a href="https://www.instagram.com/pizza.mercutio/" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-sm hover:text-accent transition">
